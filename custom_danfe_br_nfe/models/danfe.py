...
# * - Realizadas modificações apenas no layout dos campos distrito/bairro e cep. Estavam estourando com alguns dados.
...
class danfe(object):
    ...
    def destinatario(self, oXML=None, timezone=None):
        ...
        self.vline(nMr - 43, self.nlin + 8.66, 6.66)
        
        #Endereço | Bairro/Distrito
        #self.vline(nMr - 99, self.nlin + 8.66, 6.66)
        self.vline(nMr - 109, self.nlin + 8.66, 6.66)
        #Update Module - End
        ...
        self.string(nMr - 108, self.nlin + 10.3, 'BAIRRO/DISTRITO')
        
        #self.string(nMr - 52, self.nlin + 10.3, 'CEP')
        self.string(nMr - 42, self.nlin + 10.3, 'CEP')
        #Update Module - End
        ...
        self.string(nMr - 108, self.nlin + 14.3,
                    tagtext(oNode=elem_dest, cTag='xBairro'))
        
        #self.string(nMr - 52, self.nlin + 14.3,
                    #tagtext(oNode=elem_dest, cTag='CEP'))
        self.string(nMr - 42, self.nlin + 14.3,
                    tagtext(oNode=elem_dest, cTag='CEP'))        
        #Update Module - End
