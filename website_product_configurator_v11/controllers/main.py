...
class WebsiteProductConfig(http.Controller):
    ...
    def config_vars(self, product_tmpl, active_step=None, data=None):
        ...
        custom_value = request.env.ref(
            'product_configurator_v11.custom_attribute_value')
        ...
        vals = {
            ...
            'view_id': 'website_product_configurator_v11.config_form_select',
    ...
    def select_template(self, **kw):
        ...
        tmpl_ext_id = 'website_product_configurator_v11.product_configurator_list'
    ...
    def action_configure(
        ...
        template_name = 'website_product_configurator_v11.product_configurator'
    ...
    def cfg_session(self, cfg_session, **post):
        ...
        return request.render("website_product_configurator_v11.cfg_session", values)
