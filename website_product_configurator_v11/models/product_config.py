...
class ProductConfigStep(models.Model):
    ...
    view_id = fields.Many2one(
        ...
        string='Website View',
        #domain=lambda s: [('inherit_id', '=', s.env.ref('website_product_configurator.config_form_base').id)],
        domain=lambda s: [('inherit_id', '=', s.env.ref('website_product_configurator_v11.config_form_base').id)],
